...
-- RenameForeignKey
ALTER TABLE "user_memberships" RENAME CONSTRAINT "fk_um_payment" TO "user_memberships_payment_id_fkey";

-- AddForeignKey
ALTER TABLE "user_profiles" ADD CONSTRAINT "user_profiles_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "gym_amenities" ADD CONSTRAINT "gym_amenities_gym_id_fkey" FOREIGN KEY ("gym_id") REFERENCES "Gym"("gym_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_memberships" ADD CONSTRAINT "user_memberships_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;
